...
**Status: Phase 3 safe-scene-action implementation present; not a production cutover.** The Python core,
Makers adapter, CI, and companion web-console implementation include per-home scene approval,
revision-bound risk checks, and a durable console execution ledger. Remote physical execution
remains disabled until the deployed executor gates in [docs/TODO.md](docs/TODO.md) pass.
