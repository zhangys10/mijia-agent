...
- [ ] Enforce direct present-tense intent in the canonical assistant action capability. The retired direct command routes and legacy router have been removed.
