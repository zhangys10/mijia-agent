...
COMMAND_ERROR_MAP = {
    ...
    "AI_EXECUTION_STATUS_UNKNOWN": ("AI_EXECUTION_STATUS_UNKNOWN", 409, "执行结果待确认，请刷新状态核实；请勿重发。"),
    "AI_ACTION_LEDGER_UNAVAILABLE": ("AI_ACTION_LEDGER_UNAVAILABLE", 503, "安全执行记录暂时不可用，未能确认操作结果。"),
    "AI_SCENE_REVISION_CHANGED": ("AI_SCENE_REVISION_CHANGED", 409, "场景内容已变化，请重新确认后再试。"),
    "AI_SCENE_RISK_BLOCKED": ("AI_SCENE_RISK_BLOCKED", 403, "该场景包含当前不支持的操作。"),
    "AI_SCENE_NOT_EXPOSED": ("AI_SCENE_NOT_EXPOSED", 403, "该场景未获家庭成员授权。"),
    "AI_EXPOSURE_STORE_UNAVAILABLE": ("AI_EXPOSURE_STORE_UNAVAILABLE", 503, "家庭授权记录暂时不可用，请稍后再试。"),
